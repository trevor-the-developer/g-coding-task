...
namespace GuestiaCodingTask.Test
{
    public static class TestData
    {
        /// <summary>
        /// Seeds the provided context with test data
        /// </summary>
        /// <param name="context">The GuestiaContext to seed</param>
        public static void SeedData(GuestiaContext context)
        {
        ...
        /// <summary>
        /// Gets a list of test guests with their associated guest groups
        /// </summary>
        /// <returns>List of Guest objects for testing</returns>
