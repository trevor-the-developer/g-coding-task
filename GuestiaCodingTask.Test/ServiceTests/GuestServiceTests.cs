...
namespace GuestiaCodingTask.Test.ServiceTests
{
    public class GuestServiceTests : IDisposable
    {
        ...
        public GuestServiceTests()
        {
            ...
            IGuestRepository guestRepository = new GuestRepository(_context);
        ...
        public async Task GetAllUnregisteredGroupedAsync_Returns_All_GroupedGuests()
        {
            ...
            // Act
            var results = await _guestService.GetAllUnregisteredGroupedAsync();
